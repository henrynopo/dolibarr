...
class pdf_standard extends ModeleExpenseReport
{
	...
	/**
	 * @var int Column position: date
	 */
	public $posxdate;

	/**
	 * @var int Column position: type
	 */
	public $posxtype;

	/**
	 * @var int Column position: project
	 */
	public $posxprojet;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		*/
		...
		$labelStatusShort = '';
		if (is_array($object->statuts_short) && isset($object->statuts_short[$object->status])) {
			$labelStatusShort = $object->statuts_short[$object->status];
		}
		$pdf->MultiCell($this->page_largeur - $this->marge_droite - $posx, 3, $outputlangs->transnoentities($labelStatusShort), '', 'R');

...
2. **应用核心补丁**：在源码根目录（与 `htdocs` 同级）按 [patches/APPLY-ON-22.md](../patches/APPLY-ON-22.md) 中顺序依次应用 `htdocs/slycustom/patches/sly22.0-*.patch`（共 18 个）。
3. **拷贝 slycustom 模块**：将 `htdocs/slycustom/` 整个目录放入官方 22.0.4 的 `htdocs/` 下。

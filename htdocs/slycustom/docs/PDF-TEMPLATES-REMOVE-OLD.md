...
- **设置页的模板列表（如 首页 → 设置 → 发货/发票 → 文档模板）**  
  ...
  - 以及 `htdocs/slycustom/core/modules/.../doc/`（若已配置 MAIN_MODULE_SLYCUSTOM_MODELS）  
...
- `slycustom/core/modules/expedition/doc/pdf_espadon_SLY_PL.modules.php`
- `slycustom/core/modules/facture/doc/pdf_sponge_SLY_consignee.modules.php`

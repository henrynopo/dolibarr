...
if ($num > 0) {
	...
	// Ensure pos exists so Total row displays; keep nbfield from data loop (column count may be larger than header savnbfield when some header columns do not increment nbfield)
